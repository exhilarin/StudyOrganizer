...
**Study Organizer**, Python ve Tkinter kullanılarak geliştirilmiş basit bir görev yönetim uygulamasıdır.  
Bu uygulama sayesinde görevlerinizi ekleyebilir, silebilir ve isteğe bağlı olarak görevlerinize tarih atayabilirsiniz. 📅

---

## 🎯 Sunum Dosyası

Projeye ait detaylı sunum dosyasını aşağıdaki bağlantıdan inceleyebilirsiniz: 📂 [**Study Organizer - Python.pptx**](https://github.com/exhilarin/StudyOrganizer/raw/refs/heads/main/Study%20Organizer%20-%20Python.pptx)
...
🗓️ Görevler için tarih seçimi (takvim üzerinden)  
...
5. ⌨️ Uygulamadan çıkmak için `ESC` tuşuna basabilirsiniz.  

---

## 📁 Dosya Yapısı

* `Study_Organizer.py` → Uygulamanın ana Python dosyası  
